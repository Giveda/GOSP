...
The patentee of this project has not applied for any patent outside China based on the following two Chinese patents, and has not authorized anyone to apply for any patent outside China based on the following two Chinese patents. The patentee of this project has never authorized anyone to initiate a lawsuit based on the following patents. These two Chinese patents are: "How to Configure WiFi for Screenless Devices", the patent number is Z L201910116024.6; "Decoupling Methods and Computer Readable Storage Media", patent number is ZL201910381883.8. If you have been blackmailed by someone, or you know that someone has applied for relevant patents outside China based on the above two Chinese patents, please report to the following email address: mike6924@outlook.com/692463260@qq.com
